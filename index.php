...
<head>
    ...
    <meta name="description" content="Gabriel Vieira's portfolio">
    <meta name="author" content="GV">
    <title>GV | Portfolio Page</title>
    <!-- font icons -->
...
to improve myself every day. I like good challenges.
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="row ">
                        ...
                        <div class="col-7 text-left py-3">
                            ...
                            <p class="text-light mb-1">Hours For Day</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
    ...
    <section class="section" id="blog">
        <div class="container">
            <h2 class="mb-5">3 of my <span class="text-danger">Reference Projects</span></h2>
            <div class="row">
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="assets/imgs/acasias.png" alt="Acacias">
                    </div>
                    <div class="content-holder">
                        <h6 class="title">Acácias Market</h6>

                        <p class="post-details">
                            <a href="#">Created for EL Projetos</a>
                        </p>
                ...
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="assets/imgs/sfb.png" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                    </div>
                    <div class="content-holder">
                        <h6 class="title">SFB</h6>

                        <p class="post-details">
                            <a href="#">Created for C.F.B</a>
                ...
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="assets/imgs/conecta.jpg" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                    </div>
                    <div class="content-holder">
                        <h4 class="title">Conecta</h4>
                ...
                <div class="col-lg-4">
                    <div class="contact-info-card">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Email :<br> <span class="text-muted"><a href="mailto:gvgabrielvieiragabrielvieira@gmail.com"> gvgabrielvieiragabrielvieira@gmail.com</a></span></h6>
                            </div>
                        </div>
                        <ul class="social-icons pt-4">
                            <li class="social-item"><a class="social-link text-dark" href="https://www.facebook.com/chands.sti/"><i class="ti-facebook" aria-hidden="true"></i></a></li>
                            <li class="social-item"><a class="social-link text-dark" href="https://www.linkedin.com/in/gabriel-vieira-84b455164/"><i class="ti-linkedin" aria-hidden="true"></i></a></li>
                            <li class="social-item"><a class="social-link text-dark" href="https://github.com/gabrielgits"><i class="ti-github" aria-hidden="true"></i></a></li>
                        </ul> 
                    </div>
                </div>
            </div>
    ...
    <footer class="footer py-3">
        <div class="container">
            <p class="small mb-0 text-light">
                &copy; <script>document.write(new Date().getFullYear())</script> Created With <i class="ti-heart text-danger"></i> By <a href="https://github.com/gabrielgits/" target="_blank"><span class="text-danger" title="GV">GV</span></a> 
            </p>
        </div>
    </footer>
